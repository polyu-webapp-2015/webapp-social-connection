...
export module stub {
  export class User_stub extends stub.DataObject {
    ...
    /* key */
    public static __account_id():string {
      return "account_id";
    }

    public static __sex():string {
      return "sex";
    }

    public static __first_name():string {
      return "first_name";
    }

    public static __last_name():string {
      return "last_name";
    }

    public static __organization_id():string {
      return "organization_id";
    }

    public static __title_id():string {
      return "title_id";
    }

    public static __city_id():string {
      return "city_id";
    }

    public static __last_announcement_datetime():string {
