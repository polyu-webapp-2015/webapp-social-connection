...
-- Thursday, December 03, 2015 PM04:24:57 HKT
...
-- -----------------------------------------------------
-- Table `social_connection`.`Author`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `social_connection`.`Author` (
  `_id` INT(11) NOT NULL AUTO_INCREMENT,
  `first_name` CHAR(63) NULL DEFAULT NULL,
  `last_name` CHAR(63) NULL DEFAULT NULL,
  `email` CHAR(127) NOT NULL,
  `affiliation` CHAR(255) NULL DEFAULT NULL,
  `title` CHAR(7) NULL DEFAULT NULL,
  `city` CHAR(63) NULL DEFAULT NULL,
  `country` CHAR(63) NULL DEFAULT NULL,
  `dept` CHAR(15) NULL DEFAULT NULL,
  PRIMARY KEY (`_id`),
...
CREATE TABLE IF NOT EXISTS `social_connection`.`Venus` (
  ...
  CONSTRAINT `fk_Venus_Floor`
    FOREIGN KEY (`floor_id`)
    REFERENCES `social_connection`.`Floor` (`floor_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `social_connection`.`Event` (
  ...
  CONSTRAINT `fk_Event_Account_create`
    FOREIGN KEY (`creator_account_id`)
    REFERENCES `social_connection`.`Account` (`account_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Event_Account_edit`
    FOREIGN KEY (`editor_account_id`)
    REFERENCES `social_connection`.`Account` (`account_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Event_Venus`
    FOREIGN KEY (`venue_id`)
    REFERENCES `social_connection`.`Venus` (`venue_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `social_connection`.`Exhibition` (
  ...
  CONSTRAINT `fk_Exhibition_Event`
    ...
    REFERENCES `social_connection`.`Event` (`event_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `social_connection`.`Event_Attendee` (
  ...
  CONSTRAINT `fk_Event_Attendee_Account`
...
CREATE TABLE IF NOT EXISTS `social_connection`.`Friendship` (
  ...
  CONSTRAINT `fk_Friendship_Account_host`
    FOREIGN KEY (`host_id`)
    REFERENCES `social_connection`.`Account` (`account_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Friendship_Account_guest`
...
CREATE TABLE IF NOT EXISTS `social_connection`.`Message` (
  ...
  CONSTRAINT `fk_Message_Account_from`
    FOREIGN KEY (`from_account_id`)
    REFERENCES `social_connection`.`Account` (`account_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Message_Account_to`
...
-- -----------------------------------------------------
-- Table `social_connection`.`Paper`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `social_connection`.`Paper` (
  `_id` INT(11) NOT NULL AUTO_INCREMENT,
  `title` CHAR(255) NOT NULL,
  `principal_author_id` INT(11) NOT NULL,
  `file_name` CHAR(15) NULL DEFAULT NULL,
  `topic_area` CHAR(63) NULL DEFAULT NULL,
  `submission_time` DATETIME NOT NULL,
  PRIMARY KEY (`_id`),
  UNIQUE INDEX `file_name` (`file_name` ASC),
  INDEX `principal_author_id` (`principal_author_id` ASC))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `social_connection`.`Organization` (
  ...
  CONSTRAINT `fk_Organization_Country`
    FOREIGN KEY (`main_country`)
    REFERENCES `social_connection`.`Country` (`country_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `social_connection`.`User` (
  `account_id` INT(11) ZEROFILL NOT NULL AUTO_INCREMENT,
  `gender` ENUM('F', 'M', 'other', 'unknown') NULL DEFAULT NULL,
  `first_name` CHAR(63) NULL DEFAULT NULL,
  `last_name` CHAR(63) NULL DEFAULT NULL,
  ...
  CONSTRAINT `fk_User_Title`
    ...
    REFERENCES `social_connection`.`Title` (`title_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_User_Organization`
    ...
    REFERENCES `social_connection`.`Organization` (`organization_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_User_City`
    FOREIGN KEY (`city_id`)
    REFERENCES `social_connection`.`City` (`city_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 4;
...
CREATE TABLE IF NOT EXISTS `social_connection`.`Event_Organization` (
  ...
  CONSTRAINT `fk_Event_Organization_1`
    FOREIGN KEY (`event_id`)
    REFERENCES `social_connection`.`Event` (`event_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Event_Organization_2`
    FOREIGN KEY (`organization_id`)
    REFERENCES `social_connection`.`Organization` (`organization_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `social_connection`.`JsonArray` (
  ...
  `JsonArray_content` TEXT NOT NULL DEFAULT '[]',
...
CREATE TABLE IF NOT EXISTS `social_connection`.`Friendship_Tag` (
  ...
  CONSTRAINT `fk_Friendship_Tag_1`
    FOREIGN KEY (`friendship_id`)
    REFERENCES `social_connection`.`Friendship` (`friendship_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Friendship_Tag_2`
    FOREIGN KEY (`tag_id`)
    REFERENCES `social_connection`.`Tag` (`tag_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
