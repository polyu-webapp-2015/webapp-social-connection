...
-- Wednesday, December 09, 2015 PM07:29:36 HKT
...
START TRANSACTION;
USE `social_connection`;
INSERT INTO `social_connection`.`User` (`account_id`, `sex`, `first_name`, `last_name`, `organization_id`, `title_id`, `city_id`, `last_announcement_datetime`) VALUES (1, 'M', 'Beeno', 'Tung', NULL, NULL, NULL, DEFAULT);
