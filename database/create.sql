...
-- Thursday, December 17, 2015 AM02:28:07 HKT
...
-- -----------------------------------------------------
-- Data for table `social_connection`.`Venus`
-- -----------------------------------------------------
START TRANSACTION;
USE `social_connection`;
INSERT INTO `social_connection`.`Venus` (`venue_id`, `floor_id`, `venue_name`) VALUES (1, 4, 'Main Hall');
INSERT INTO `social_connection`.`Venus` (`venue_id`, `floor_id`, `venue_name`) VALUES (2, 4, 'August Hall');
INSERT INTO `social_connection`.`Venus` (`venue_id`, `floor_id`, `venue_name`) VALUES (3, 5, 'Blaine Hall');
INSERT INTO `social_connection`.`Venus` (`venue_id`, `floor_id`, `venue_name`) VALUES (4, 5, 'Cosmo Hall');
...
INSERT INTO `social_connection`.`Post` (`post_Id`, `subject`, `description`, `discussboard_id`, `creator_account_id`, `editor_account_id`, `create_time`, `edit_time`, `deleted`) VALUES (2, 'Spam post', 'this is spam description', 1, 5, 5, DEFAULT, DEFAULT, DEFAULT);
...
INSERT INTO `social_connection`.`Reply` (`reply_id`, `post_Id`, `message`, `creator_account_id`, `editor_account_id`, `create_time`, `edit_time`, `deleted`) VALUES (2, 1, 'Guess what? This is spam !', 5, 5, DEFAULT, DEFAULT, DEFAULT);
