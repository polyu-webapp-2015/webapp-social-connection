...
-- Sunday, December 20, 2015 PM05:44:02 HKT
...
ENGINE = InnoDB
COMMENT = 'E \'exhibition\'\nS \'session\'\nA \'attraction\'\n\n//TODO disable default value for event_time\n\nthe venue is used directly to reduce Client side coding work load';
...
ENGINE = InnoDB
AUTO_INCREMENT = 4
COMMENT = 'the organization,city, country, title is use directly to reduce client side coding work load';
...
-- -----------------------------------------------------
-- Table `social_connection`.`SessionReply`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `social_connection`.`SessionReply` ;

CREATE TABLE IF NOT EXISTS `social_connection`.`SessionReply` (
  `reply_id` INT NOT NULL AUTO_INCREMENT,
  `event_id` INT NOT NULL,
  `message` TEXT NOT NULL,
  `creator_account_id` INT NOT NULL,
  ...
  INDEX `fk_Reply_Account_create_idx` (`creator_account_id` ASC),
  INDEX `fk_Reply_Account_edit_idx` (`editor_account_id` ASC),
  INDEX `fk_Reply_Post_idx` (`event_id` ASC))
ENGINE = InnoDB;
...
START TRANSACTION;
USE `social_connection`;
INSERT INTO `social_connection`.`Event` (`event_id`, `create_time`, `edit_time`, `event_type`, `venue_id`, `event_time`, `creator_account_id`, `editor_account_id`, `subject`, `description`, `quota`, `venue`) VALUES (1, DEFAULT, DEFAULT, 'S', 1, DEFAULT, 1, 1, 'Opening Session', 'Description of the Opening Session', 500, 'Core Hall');
INSERT INTO `social_connection`.`Event` (`event_id`, `create_time`, `edit_time`, `event_type`, `venue_id`, `event_time`, `creator_account_id`, `editor_account_id`, `subject`, `description`, `quota`, `venue`) VALUES (2, DEFAULT, DEFAULT, 'S', 1, DEFAULT, 1, 1, 'Session 2 part A', 'desctions.......', 250, 'Main Hall');
INSERT INTO `social_connection`.`Event` (`event_id`, `create_time`, `edit_time`, `event_type`, `venue_id`, `event_time`, `creator_account_id`, `editor_account_id`, `subject`, `description`, `quota`, `venue`) VALUES (3, DEFAULT, DEFAULT, 'E', 2, DEFAULT, 1, 1, 'Exbihition on The green Hotel facility', 'desctions.......', 250, 'Blaine Hall');
...
START TRANSACTION;
USE `social_connection`;
INSERT INTO `social_connection`.`User` (`account_id`, `sex`, `first_name`, `last_name`, `organization_id`, `title_id`, `city_id`, `last_announcement_datetime`, `organization`, `city`, `country`, `title`) VALUES (1, 'M', 'Beeno', 'Tung', 1, 1, 1, DEFAULT, 'PolyU', 'Hong Kong', 'China', 'Mr.');
INSERT INTO `social_connection`.`User` (`account_id`, `sex`, `first_name`, `last_name`, `organization_id`, `title_id`, `city_id`, `last_announcement_datetime`, `organization`, `city`, `country`, `title`) VALUES (2, 'M', 'Eric', 'Wong', 2, 4, 3, DEFAULT, 'PolyU', 'Hong Kong', 'China', 'Sir.');
INSERT INTO `social_connection`.`User` (`account_id`, `sex`, `first_name`, `last_name`, `organization_id`, `title_id`, `city_id`, `last_announcement_datetime`, `organization`, `city`, `country`, `title`) VALUES (3, 'F', 'Mary', 'Wu', 3, 2, 2, DEFAULT, '', 'Nagasaki', 'Japan', 'Miss.');
INSERT INTO `social_connection`.`User` (`account_id`, `sex`, `first_name`, `last_name`, `organization_id`, `title_id`, `city_id`, `last_announcement_datetime`, `organization`, `city`, `country`, `title`) VALUES (4, 'M', 'Peter', 'Lee', 3, 6, 2, DEFAULT, 'E&F Enterprise Hotel', 'Tokyo', 'Japan', 'Mr.');
INSERT INTO `social_connection`.`User` (`account_id`, `sex`, `first_name`, `last_name`, `organization_id`, `title_id`, `city_id`, `last_announcement_datetime`, `organization`, `city`, `country`, `title`) VALUES (5, 'F', '', '', 1, 1, 1, DEFAULT, '', '', '', '');
