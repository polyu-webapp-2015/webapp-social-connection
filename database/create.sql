...
-- Friday, December 11, 2015 PM09:53:39 HKT
...
START TRANSACTION;
USE `social_connection`;
INSERT INTO `social_connection`.`Country` (`country_id`, `country_name`) VALUES (1, 'China');
INSERT INTO `social_connection`.`Country` (`country_id`, `country_name`) VALUES (2, 'Japan');
INSERT INTO `social_connection`.`Country` (`country_id`, `country_name`) VALUES (3, 'Korea');
...
START TRANSACTION;
USE `social_connection`;
INSERT INTO `social_connection`.`Organization` (`organization_id`, `organization_type`, `name`, `main_country`) VALUES (1, 'academic', 'Poly U', 1);
INSERT INTO `social_connection`.`Organization` (`organization_id`, `organization_type`, `name`, `main_country`) VALUES (2, 'business', 'E&F Enterprise Hotel', 2);
...
START TRANSACTION;
USE `social_connection`;
INSERT INTO `social_connection`.`City` (`city_id`, `country_id`, `city_name`) VALUES (1, 1, 'Hong Kong');
INSERT INTO `social_connection`.`City` (`city_id`, `country_id`, `city_name`) VALUES (2, 2, '長崎 (Nagasaki)');
INSERT INTO `social_connection`.`City` (`city_id`, `country_id`, `city_name`) VALUES (3, 1, 'BaiJin');
...
INSERT INTO `social_connection`.`User` (`account_id`, `sex`, `first_name`, `last_name`, `organization_id`, `title_id`, `city_id`, `last_announcement_datetime`) VALUES (2, 'M', 'Eric', 'Wong', 1, 4, 3, DEFAULT);
INSERT INTO `social_connection`.`User` (`account_id`, `sex`, `first_name`, `last_name`, `organization_id`, `title_id`, `city_id`, `last_announcement_datetime`) VALUES (3, 'F', 'Mary', 'Wu', 2, 2, 2, DEFAULT);
INSERT INTO `social_connection`.`User` (`account_id`, `sex`, `first_name`, `last_name`, `organization_id`, `title_id`, `city_id`, `last_announcement_datetime`) VALUES (4, 'M', 'Peter', 'Lee', 2, 6, 2, DEFAULT);
