...
-- Thursday, December 17, 2015 AM02:51:57 HKT
...
INSERT INTO `social_connection`.`User` (`account_id`, `sex`, `first_name`, `last_name`, `organization_id`, `title_id`, `city_id`, `last_announcement_datetime`) VALUES (6, 'M', 'Spam', 'Producer', 1, 1, 1, DEFAULT);
