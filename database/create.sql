...
-- Wednesday, December 09, 2015 PM06:41:50 HKT
...
-- -----------------------------------------------------
-- Table `social_connection`.`Account_Announcement`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `social_connection`.`Account_Announcement` ;

CREATE TABLE IF NOT EXISTS `social_connection`.`Account_Announcement` (
  `account_id` INT NOT NULL,
  `announcement_id` INT NOT NULL,
  `create_time` DATETIME NOT NULL DEFAULT now(),
  PRIMARY KEY (`account_id`, `announcement_id`),
  INDEX `fk_Account_Announcement_2_idx` (`announcement_id` ASC))
ENGINE = InnoDB
COMMENT = 'the time when user read an announcement.\nthis allow the system to distinct \"new\" and \"old\" announcement for each user';
